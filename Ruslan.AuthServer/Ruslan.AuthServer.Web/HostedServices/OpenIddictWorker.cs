...
namespace Ruslan.AuthServer.Web.HostedServices;
    ...
    public async Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        if (await manager.FindByClientIdAsync(client_id2, cancellationToken) is null)
        {
            ...
            await manager.CreateAsync(new OpenIddictApplicationDescriptor
            {
                ...
                RedirectUris = {
                    new Uri("https://localhost:7060/signin-oidc"),                      // Ruslan.BlazorApp see folder ClientSamples in repository
                ...
                {
                    new Uri("https://localhost:7060/signout-callback-oidc")              // Ruslan.BlazorApp see folder ClientSamples in repository
                },
                Permissions =
                {
                    // Endpoint permissions
